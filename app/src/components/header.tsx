...
const Header: React.FC<HeaderProps> = ({ title }) => {
    ...
    const menus = [
        ...
        { id: 'liveNow', src: 'logo_live', guide: '사이트에 등록된 단어와 이미지를 찾아보고 추가로 등록할 수 있는 라이브러리 페이지입니다. 이미지 카드를 클릭하여 사진이 의미하는 단어와 그에 담긴 이야기를 읽어보세요! 아래에 + 버튼을 눌러 나의 사진과 단어를 등록해주세요.' },
